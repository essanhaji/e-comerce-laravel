...
{use BreadRelationshipParser;
    ...
    public function update(Request $request, $id)
    {
        ...
        //our modification to update Category too : 
        //1st on va supprimmer les categories de ce produit, pour ajouter les nouveaux :
        CategoryProduct::where('product_id',$id)->delete();

        //re-insert categories to this product :
        if($request->category){
